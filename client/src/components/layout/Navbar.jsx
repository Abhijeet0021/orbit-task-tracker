...
import { Bell, LogOut, Layers, UserCheck, ChevronDown } from 'lucide-react';
    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/95 px-6 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {showPersonaMenu && (
            <div className="absolute right-0 mt-2 w-80 rounded-xl border border-slate-200 bg-white p-2 shadow-xl z-50 animate-in fade-in slide-in-from-top-2 duration-150">
