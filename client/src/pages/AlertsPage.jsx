  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <span className="px-3 py-1 rounded-full text-sm font-black bg-rose-100 text-rose-800 border border-rose-200">
          {alertCount} Active Alert{alertCount !== 1 ? 's' : ''}
        </span>
      </div>

      <div className="p-4 rounded-2xl bg-blue-50/70 border border-blue-200 text-sm text-blue-900 flex items-start gap-2.5">
      ...
      {loading ? (
        ...
        <div className="p-12 text-center rounded-3xl bg-white border border-slate-200 shadow-xs">
          ...
          <p className="text-sm text-slate-400 mt-1">No overdue tasks assigned to you right now.</p>
        </div>
      ) : (
            ...
            >
              <div className="space-y-1.5 max-w-2xl">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-sm font-black px-2 py-0.5 rounded bg-rose-50 text-rose-700 border border-rose-200">
                    {alert.task_code}
                  </span>
                ...
                <div className="flex items-center gap-3 text-sm text-rose-600 font-semibold">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 bg-slate-50 text-slate-600 text-sm font-bold hover:bg-slate-100 hover:text-slate-900 transition"
