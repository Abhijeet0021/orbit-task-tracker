    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 rounded-3xl bg-white shadow-2xl overflow-hidden border border-slate-100">
        <div className="bg-slate-50/80 p-8 border-r border-slate-200 flex flex-col justify-between">
            ...
            <div className="space-y-2.5">
              {demoAccounts.map(account => (
                ...
                >
                  ...
                  <div className="mt-2 flex items-center gap-1 text-[11px] font-semibold text-blue-600 opacity-0 group-hover:opacity-100 transition">
          ...
          <div className="pt-4 mt-6 border-t border-slate-200/80 text-[11px] text-slate-400">
        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500 mt-1">Enter your credentials below to access your projects.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-xs text-slate-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-hidden bg-slate-50/50"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-2.5 rounded-xl bg-blue-600 text-white text-xs font-bold hover:bg-blue-700 disabled:opacity-50 transition shadow-md shadow-blue-500/20"
            >
